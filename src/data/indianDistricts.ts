export const stateDistricts: Record<string, string[]> = {
  "Andhra Pradesh": [
    ...
    "Krishna", "Kurnool", "Manyam (Parvathipuram Manyam)", "Nandyal",
    "Nellore (Sri Potti Sriramulu Nellore)", "NTR", "Palnadu", "Prakasam",
